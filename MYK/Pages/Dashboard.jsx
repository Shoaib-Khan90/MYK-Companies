...
const Dashboard = () => {
  ...
  <div className="company-heading">
    ...
    <p>
      SERVICE PROVIDERS TO THE FINANCIAL, BUSINESS & PROFESSIONAL
      SECTOR OF PAKISTAN
    </p>
  </div>
...
<section className="features-section">
  <div className="features-container">
    ...
    <div className="feature-card">
      ...
      <p>
       We are committed to providing a professional work environment that encourages and rewards dedication, teamwork, honesty and reliability.
      </p>
    </div>
    ...
    <div className="feature-card">
      ...
      <p>
        Dedicated to our clientele by providing seamless services. Driven by excellence in professionalism and high standards.
      </p>
    </div>
    ...
    <div className="feature-card">
      ...
      <p>
        Our ultimate goal is to set ourselves apart as a credible industry leader, dedicated to providing seamless services and value that our clients can trust.
      </p>
    </div>
  </div>
</section>
...
<section className="why-section">
  ...
  <div className="why-container">
    ...
    <div className="why-card">
      ...
      <p>
        Providing outstanding services through teamwork,
    ...
    <div className="why-card">
      ...
      <p>
        Through teamwork, experience, accountability and
        innovation – all of which is reflected in the quality
        of our services.
      </p>
    </div>
    ...
    <div className="why-card">
      ...
      <p>
        By understanding, responsibility and continuous
        improvement.
      </p>
    </div>
  </div>
...
<section className="team-section">
  ...
  <div className="team-content">
    ...
    <p>
      MYK is a company built around two core assets: the services to its valued
      clients and its people. We believe work is more than just a place you go
      every day. It should be a place of professional growth, analysis and
      interpersonal relationships. It’s about being motivated and inspired to
      achieve certain goals. We encourage our team to take pride in their work
      and in providing exceptional solutions to our clients.
    </p>
    ...
    <p>
      Employee training and development is essential for both new and existing
      businesses. In order for an employee to perform their job well, it is
      important for us to give them the training and tools they need to be
      responsible productive team members. At MYK we conduct workshops &
      on-site training programs for all our employees. Our company also attends
      conferences and seminars to keep our employees up-to-date in new
      techniques and technologies in their respective field of work.
    </p>
...
<section className="clientele-section">
  ...
  <div className="clientele-heading">
    ...
    <p>
      We are proud to work with leading organizations and valued clients
