          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-slate-600 text-base sm:text-lg leading-8">
                ...
                We strive to empower businesses and communities with reliable,
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border-l-4 border-amber-500">
          ...
          <p className="text-slate-600 leading-7">
            We specialize in solar, wind, and hydroelectric power solutions,
            helping clients harness natural resources to reduce their carbon
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border-l-4 border-amber-500">
          ...
          <p className="text-slate-600 leading-7">
            Our cutting-edge battery storage technologies enable businesses to
            store excess energy for use during peak demand, enhancing
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border-l-4 border-amber-500">
          ...
          <p className="text-slate-600 leading-7">
            We offer expert assessments and strategies to optimize energy use,
            reduce waste, and lower operational costs through smart technology
            and best practices.
          </p>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border-l-4 border-amber-500">
          ...
          <p className="text-slate-600 leading-7">
            Recognizing the rapid growth in the electric vehicle market, we
            provide automotive and electric bike batteries. By focusing heavily
            on research and development, we cater to the evolving demands of
            Pakistan’s two-wheeled electric vehicle and automotive battery
            markets.
          </p>
        </div>
